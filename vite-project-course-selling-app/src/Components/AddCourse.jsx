...
const AddCourse = () => {
  ...
  return (
    <>
        <div className='h-[90vh] w-full bg-gray-100 flex flex-col items-center'>
            <h1 className='text-2xl font-medium mb-4 mt-24'>Add Course here...........</h1>
            <div className='bg-white w-[520px] rounded-xl shadow-lg flex  flex-col justify-center gap-3 p-8 h-[45vh] '>
            <div>
